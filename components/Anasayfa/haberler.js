...
import { Platform, ScrollView, StyleSheet, Dimensions, View, Image, Text, ImageBackground } from 'react-native';
...
class Haberler extends React.PureComponent<Props> {
	constructor(props) {
		super(props);
	...
	makeRemoteRequest = () => {
		...
		return fetch('https://raw.githubusercontent.com/partitect/cobi/master/haberler.json')
