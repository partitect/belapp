  ...
  render() {
    return (
      ...
      <View>
        ...
        <Headline style={styles.header}>ALÇAK KÖPRÜ</Headline><Image
          style={{width: '100%', height: 200}}
        ...
        <Headline style={styles.header}>AMASYA SAAT KULESİ</Headline><Image
          style={{width: '100%', height: 200}}
        ...
        <Headline style={styles.header}>HALİFET GAZİ TÜRBESİ</Headline><Image
          style={{width: '100%', height: 200}}
