    ...
    return (
      <View>
        <Appbar.Header>
          ...
          <Appbar.Content title="Anasayfa"/>
        </Appbar.Header>
        <ScrollView style={styles.mainContent}>
        <Headline >AMASYA' NIN TARİHİ</Headline>
        <Image
        ...
        <Headline >AMASYA KALESİ</Headline> 
        <Image
          style={{width: '100%', height: 200}}
        ...
        <Headline >AYNALI MAĞARA</Headline>
        <Image
          style={{width: '100%', height: 200}}
        ...
        <Headline >ALÇAK KÖPRÜ</Headline><Image
          style={{width: '100%', height: 200}}
          source={{uri: 'http://40dk.com/v2/wp-content/uploads/2017/07/amasya-al%C3%A7ak-k%C3%B6pr%C3%BC-01.jpg'}}
        />
        <Text style={styles.paragraph}>
        ...
        <Headline >AMASYA SAAT KULESİ</Headline><Image
          style={{width: '100%', height: 200}}
        ...
        <Headline >HALİFET GAZİ TÜRBESİ</Headline><Image
          style={{width: '100%', height: 200}}
          source={{uri: 'https://www.kulturportali.gov.tr/repoKulturPortali/large/07022013/5988efc2-f9d6-4b1d-8546-2faeab375630.jpg'}}
        />
        <Text style={styles.paragraph}>
        ...
        <Headline >BORABAY GÖLÜ</Headline>
        <Image
          style={{width: '100%', height: 200}}
          source={{uri: 'https://4.bp.blogspot.com/-D_wO93jBQAc/VCcCB9qO1DI/AAAAAAAAD84/mih4aSkti6E/s1600/Borabay%2BG%C3%B6l%C3%BC%2BAmasya.jpg'}}
        />
        <Text style={styles.paragraph}>
        ...
        <Headline >AMASYA ARKEOLOJİ MÜZESİ</Headline>
        <Image
          style={{width: '100%', height: 200}}
          source={{uri: 'https://3.bp.blogspot.com/-heUK9yhALfQ/V4kJ9VGDoLI/AAAAAAAAAB0/JP4W5kuU6hMOOKaeAoHjB2eWnt6dIw3VQCLcB/s1600/m3.JPG'}}
        />
        <Text style={styles.paragraph}>
