...
class ImarKomisyonu extends React.Component {
  ...
  makeRemoteRequest = () => {
    return fetch(
      "https://raw.githubusercontent.com/partitect/cobi/master/imar.json"
    )
    ...
    return (
      <View style={{ flex: 1 }}>
        <Appbar.Header>
          ...
          />
          <Appbar.Content title="Amasya Belediyesi" subtitle="İmar Komisyonu" />
        ...
        Amasya Belediyesi İmar Komisyonu
        </Headline>
