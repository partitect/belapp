...
class PlanButceKomisyonu extends React.Component {
	...
	makeRemoteRequest = () => {
		return fetch('https://raw.githubusercontent.com/partitect/cobi/master/planbutce.json')
	...
	render() {
		...
		return (
			<View style={{ flex: 1 }}>
				...
				>
					<Headline style={styles.header}>Amasya Belediyesi Plan Bütçe Komisyonu</Headline>

					<Divider style={{ marginBottom: 10 }} />
					{this.state.isLoading ? (
						<PCards data={this.state.content} OnPress={this.onPress} navScreen="PlanButceKomisyonu" />
					) : (
