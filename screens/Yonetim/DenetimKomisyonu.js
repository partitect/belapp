...
class DenetimKomisyonu extends React.Component {
  ...
  makeRemoteRequest = () => {
    return fetch(
      "https://raw.githubusercontent.com/partitect/cobi/master/denetim.json"
    )
    ...
    return (
      <View style={{ flex: 1 }}>
        <Appbar.Header>
          ...
          />
          <Appbar.Content title="Amasya Belediyesi" subtitle="Denetim Komisyonu" />
        ...
        Amasya Belediyesi Denetim Komisyonu
        </Headline>
