...
class MeclisUyeleri extends React.Component {
	...
	makeRemoteRequest = () => {
		return fetch('https://raw.githubusercontent.com/partitect/cobi/master/meclis.json')
	...
	render() {
		...
		return (
			<View style={{ flex: 1 }}>
				...
				>
					<Headline style={styles.header}>2019-2024 YILLARI DÖMEMİNE AİT</Headline>
					<Headline style={styles.header}>BELEDİYE MECLİS ÜYELERİ LİSTESİ</Headline>
					<Divider style={{ marginBottom: 10 }} />
					{this.state.isLoading ? (
						<PCards data={this.state.content} OnPress={this.onPress} navScreen="MeclisUyeleri" />
					) : (
