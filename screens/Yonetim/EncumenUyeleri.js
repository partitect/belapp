...
class EncumenUyeleri extends React.Component {
	...
	makeRemoteRequest = () => {
		return fetch('https://raw.githubusercontent.com/partitect/cobi/master/encumen.json')
	...
	render() {
		...
		return (
			<View style={{ flex: 1 }}>
				...
				>
					<Headline style={styles.header}>Amasya Belediyesi Encümen Üyeleri</Headline>

					<Divider style={{ marginBottom: 10 }} />
					{this.state.isLoading ? (
						<PCards data={this.state.content} OnPress={this.onPress} navScreen="EncumenUyeleri" />
					) : (
